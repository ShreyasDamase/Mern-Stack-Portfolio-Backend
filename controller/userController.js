...
export const register = catchAsyncErrors(async (req, res, next) => {
  ...
  const user = await User.create({
    ...
    linkedInURL,
    avatar: {
      public_id: cloudinaryResponseForAvatar.public_id, // Use cloudinaryResponseForAvatar
      url: cloudinaryResponseForAvatar.secure_url, // Use cloudinaryResponseForAvatar
    },
    resume: {
      public_id: cloudinaryResponseForResume.public_id, // Use cloudinaryResponseForResume
      url: cloudinaryResponseForResume.secure_url, // Use cloudinaryResponseForResume
    },
  });
...
export const getUserForPortfolio = catchAsyncErrors(async (req, res, next) => {
  const id = "66ef215b9f8780101adfdbb0";
